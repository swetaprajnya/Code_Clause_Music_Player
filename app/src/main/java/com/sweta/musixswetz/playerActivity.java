...
public class playerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String endTime = createItem(mediaPlayer.getDuration());
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                String currentTime = createItem(mediaPlayer.getCurrentPosition());
    ...
    public String createItem(int duration)
    {
        String time = "";
